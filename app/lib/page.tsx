...
export default function CheckoutPage() {
  ...
  // Calculate final total including shipping and coupon discount
  ...
  const handleCustomerInfoSubmit = async (data: typeof customerInfo) => {
    try {
      ...
      if (typeof window !== 'undefined' && (window as any).trackGoogleAdsBeginCheckout) {
        ...
        (window as any).trackGoogleAdsBeginCheckout(itemsData, finalTotal, 'AED');
      }
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <CouponInput
                  ...
                  orderAmount={totalPrice + shippingCost}
