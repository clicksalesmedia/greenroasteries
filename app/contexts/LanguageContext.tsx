...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'tax': 'Tax',
    'discount': 'Discount',
    'tabby_payment': 'Pay later with Tabby',
    'pay_in_4_installments': 'Pay in 4 interest-free installments',
    'continue_with_tabby': 'Continue with Tabby',
    'tabby_not_available': 'Tabby payment is not available for this order. Please use your credit/debit card below.',
    'tabby_payment_cancelled': 'You cancelled the payment with Tabby. You can try again or choose a different payment method.',
    ...
    'try_card_payment': 'You can continue with your credit/debit card below.',
    'tabby_general_rejection': 'Sorry, Tabby is unable to approve this purchase. Please use an alternative payment method for your order.',
    'tabby_amount_too_high': 'This purchase is above your current spending limit with Tabby, try a smaller cart or use another payment method',
    'tabby_amount_too_low': 'The purchase amount is below the minimum amount required to use Tabby, try adding more items or use another payment method',
    ...
    'newsletter_desc': 'Get exclusive offers and the latest updates delivered to your inbox',
  ...
  ar: {
    ...
    'tax': 'الضريبة',
    'discount': 'الخصم',
    'tabby_payment': 'ادفع لاحقًا عبر تابي​',
    'pay_in_4_installments': 'ادفع على 4 أقساط بدون فوائد',
    'continue_with_tabby': 'المتابعة مع تابي',
    'tabby_not_available': 'دفع تابي غير متاح لهذا الطلب. يرجى استخدام بطاقتك الائتمانية/المصرفية أدناه.',
    'tabby_payment_cancelled': 'لقد ألغيت الدفع عبر تابي. يمكنك المحاولة مرة أخرى أو اختيار طريقة دفع مختلفة.',
    'tabby_payment_failed': 'نأسف، تابي غير قادرة على الموافقة على هذه العملية. الرجاء استخدام طريقة دفع أخرى.',
    'try_card_payment': 'يمكنك المتابعة ببطاقتك الائتمانية/المصرفية أدناه.',
    'tabby_general_rejection': 'نأسف، تابي غير قادرة على الموافقة على هذه العملية. الرجاء استخدام طريقة دفع أخرى.',
    'tabby_amount_too_high': 'قيمة الطلب تفوق الحد الأقصى المسموح به حاليًا مع تابي. يُرجى تخفيض قيمة السلة أو استخدام وسيلة دفع أخرى.',
    'tabby_amount_too_low': 'قيمة الطلب أقل من الحد الأدنى المطلوب لاستخدام خدمة تابي. يُرجى زيادة قيمة الطلب أو استخدام وسيلة دفع أخرى.',
    ...
    'stay_updated': 'تبقى مع التحديثات',
    'newsletter_desc': 'احصل على العروض الخاصة والتحديثات الأخيرة يصلك بالبريد الإلكتروني',
    'newsletter_success': 'تم الاشتراك في النشرة الإخبارية بنجاح!',
    'newsletter_error': 'فشل الاشتراك. يرجى المحاولة مرة أخرى.',
    'network_error': 'خطأ الشبكة. يرجى المحاولة مرة أخرى.',
