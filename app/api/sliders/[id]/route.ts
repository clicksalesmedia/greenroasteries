...
export async function PUT(
  ...
  try {
    ...
    const updateData = {
      ...
      textColor: data.textColor || existingSlider.textColor || '#111111',
      buttonColor: data.buttonColor || existingSlider.buttonColor || '#111111',
      overlayColor: data.overlayColor || existingSlider.overlayColor || 'rgba(0,0,0,0)',
      overlayOpacity: data.overlayOpacity !== undefined ? data.overlayOpacity : existingSlider.overlayOpacity || 0,
      overlayImageUrl: data.overlayImageUrl || existingSlider.overlayImageUrl || null,
