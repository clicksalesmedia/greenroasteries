/**
 * Test Tabby Payment Capture for Latest Payment
 * This script tests the capture of payment eea232a1-bfdd-475c-a3fc-3958ca765ed7
 */

const https = require('https');

const PAYMENT_ID = 'eea232a1-bfdd-475c-a3fc-3958ca765ed7';
...
const capturePayload = {
  amount: "266.21", // Full amount from the order
  ...
  items: [
    {
      ...
      description: "Premium Nicaragua coffee & salted nuts from Green Roasteries",
      quantity: 1,
      unit_price: "266.21",
      discount_amount: "0.00",
      reference_id: "1a92fce3-6401-4e59-81b0-770b4a7743bd",
      ...
      is_refundable: true,
      barcode: `GR${Date.now()}`,
      ppn: `GR-1a92fce3-6401-4e59-81b0-770b4a7743bd`,
      seller: "Green Roasteries"
    }
  ]
};

console.log('🔵 Testing Tabby Payment Capture for Latest Payment');
